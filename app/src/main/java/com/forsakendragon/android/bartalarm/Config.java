...
public class Config {
    ...
    public static final String BART_API = "http://api.bart.gov/api/stn.aspx?cmd=";

    public static final String STATION_LIST_COMMAND = BART_API + "stns&key=" + BART_KEY;
    ...
    public static final String SCHEDUAL_DEPART_COMMAND_1 = BART_API + "depart&orig=";
